...
def get_data_loaders(conf):
    ...
    train_loader = DataLoader(train_images, batch_size=conf.batch_size, shuffle=True, num_workers=conf.nb_workers)
    val_loader = DataLoader(val_images, batch_size=int(conf.batch_size/4), shuffle=False, num_workers=conf.nb_workers)
    test_loader = DataLoader(test_images, batch_size=int(conf.batch_size/4), shuffle=False, num_workers=conf.nb_workers)
    data_sizes = {'train': len(train_images), 'val': len(val_images), 'test': len(test_images)}
