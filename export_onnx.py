...
class Convert_model(object):
    ...
    def export_model(self):
        batch_size=1
        x = torch.randn(batch_size, 3, self.input_size, self.input_size, requires_grad=True)
        print("[INFO] Exporting ONNX Model ....")
        torch.onnx.export(self.model, x.to(self.device),
...
def parse_args():
    ...
    parser.add_argument('--network', type=str, help='[resnet18, resnet34, resnet50, mobilenet_v2, mobilenet_v3_small]')
